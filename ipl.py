...
c = 1
def action_pass(a):
    global turn, pic_no, turn_team, check
    ...
    if turn % 4 == 0 and turn > 0:
        turn += 1
        pic_no += 1
        file = 'C:/Users/renu/Downloads/assets/' + str(pic_no) + '.png'
        ...
        if a==2:
            ...
            if check == 1:
                db = Mysqldb.connect('localhost', 'root', 'Myworld3', 'ipl')
                cursors = db.cursor()
                global pic_no1
...
background_image = PhotoImage(file="C:/Users/renu/Downloads/assets/ipl-auction.png")
